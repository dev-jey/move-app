      ...
      "attachments": [
        {
          ...
          "title_link": "https://github.com/andela/tembea-frontend/commit/$GIT_COMMIT",
          "color": "${3}",
          "actions": [
            {
              "text": "View Commit",
              "type": "button",
              "url": "https://github.com/andela/tembea-frontend/commit/${GIT_COMMIT}",
              "style": "${4}"
            },
            {
              "text": "View Build",
...
send_success_notification(){
  ...
  STYLE="primary"
  COLOR="good"
  send_notification "Frontend: ${NOTIFICATION_TITLE}" "${TEXT}" "${COLOR}" "${STYLE}"
}
...
send_failure_notification(){
  ...
  then
    ...
    NOTIFICATION_BODY="Tembea frontend deployment for ${GIT_BRANCH} failed."
  else
